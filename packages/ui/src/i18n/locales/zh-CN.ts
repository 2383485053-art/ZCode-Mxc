...
const zhCN: Record<string, string> = {
  ...
  "settings.agentTeams.title": "智能体团队",
  "settings.agentTeams.enable": "启用智能体团队",
  "settings.agentTeams.enableDescription":
    "开启后，领队智能体可以创建团队、拆分任务并合流队员产出。配置保存后对之后新开的会话生效。",
  "settings.agentTeams.maxTeammates": "团队人数上限",
  "settings.agentTeams.maxTeammatesDescription": "单个团队最多容纳的队员数量（1-16）。",
  "settings.agentTeams.loadFailed": "智能体团队配置读取失败，请重试。",
  "settings.agentTeams.updateFailed": "智能体团队配置保存失败",
